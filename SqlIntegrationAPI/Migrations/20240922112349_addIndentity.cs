        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Period = table.Column<TimeSpan>(type: "Time", nullable: false, defaultValue: new TimeSpan(0, 0, 30, 0, 0)),
                    QueryString = table.Column<string>(type: "nvarchar(max)", nullable: true, defaultValue: "cross-company=true"),
                    TableAltered = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    Status = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true, defaultValue: "Running"),
                    LastRun = table.Column<DateTime>(type: "datetime2", maxLength: 255, nullable: true),
                    ...
                    NextRun = table.Column<DateTime>(type: "datetime2", maxLength: 255, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Services", x => x.RecId);
                });
