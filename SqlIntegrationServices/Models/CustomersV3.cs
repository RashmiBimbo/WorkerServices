...
public abstract partial class CustomersV3Base
{
    [StringLength(2000)]
    ...
    [StringLength(2000)]
    public string? AllowOnAccount { get; set; }
    ...
    [StringLength(2000)]
    public string? IsSimplifiedDeliveryAddress { get; set; }

    [StringLength(2000)]
    public string? IsSimplifiedInvoiceAddress { get; set; }

    [StringLength(2000)]
    public string? IsSimplifiedPrimaryAddress { get; set; }

    [StringLength(2000)]
    public string? OutletClassCode { get; set; }
    ...
    [StringLength(2000)]
    public string? SupervisorNameBak { get; set; }

    [StringLength(2000)]
    public string? TaxRegimeCode_MX { get; set; }

    [StringLength(2000)]
    public string? CFDITemporaryExport_MX { get; set; }

    [StringLength(2000)]
    public string? Platform { get; set; }

    [StringLength(2000)]
    public string? SATRegistrationName_MX { get; set; }
    ...
    [StringLength(2000)]
    public string? CustomerCodeForRetailer { get; set; }

    [StringLength(2000)]
    public string? DlvMode { get; set; }

    [StringLength(2000)]
    public string? ReplacedCustomerCode { get; set; }
    ...
    [StringLength(2000)]
    public string? HGDiscountRebateSlab { get; set; }

    [StringLength(2000)]
    public string? IsExportedtoSFTP { get; set; }

    [Column(TypeName = "decimal(28, 6)")]
    public decimal? AddressLatitudeNew { get; set; }

    [Column(TypeName = "decimal(28, 6)")]
    public decimal? AddressLongitudeNew { get; set; }
