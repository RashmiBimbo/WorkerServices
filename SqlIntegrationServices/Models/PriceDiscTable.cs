...
[Index("AccountRelation", "InventDimId", Name = "idx_AccountRelationInventDimId")]
[Index("AccountRelation", "InventDimId", "ItemRelation", "FromDate", Name = "idx_AccountRelationInventDimIdItemRelationFromDate")]
[Index("AccountRelation", "dataAreaId", "InventDimId", "FromDate", "ToDate", Name = "idx_AccountRelationdataAreaIdInventDimIdFromDateToDate")]
[Index("AccountRelation", "dataAreaId", "InventDimId", "ToDate", Name = "idx_AccountRelationdataAreaIdInventDimIdToDate")]
[Index("InventDimId", "ToDate", Name = "idx_InventDimIdToDate")]
[Index("dataAreaId", "InventDimId", "ItemRelation", Name = "idx_dataAreaIdInventDimIdItemRelation")]
[Index("dataAreaId", "InventDimId", "FromDate", "ToDate", Name = "idx_dataareidInventDimeFdate")]
public abstract partial class PriceDiscTableBase
{
    [StringLength(2000)]
...
public partial class PriceDiscTableTest : PriceDiscTableBase { }

public partial class PriceDiscTable : PriceDiscTableBase { }
